      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 max-w-7xl">
        <div className="flex flex-col items-center bg-gray-900/20 rounded-3xl p-8 md:p-12 border border-gray-700/30">
          <div className="text-center max-w-3xl">
            ...
            <p className="text-gray-400">
              Our platform isn&apos;t just about making calls—it&apos;s about creating meaningful connections that drive business growth. We&apos;ve combined cutting-edge AI technology with deep understanding of sales psychology to create a solution that works.
            </p>
          </div>
        </div>
      </div>
